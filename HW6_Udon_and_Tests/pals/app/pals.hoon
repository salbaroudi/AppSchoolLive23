...
:: Import, build, evaluate and pin the results of many hoon files in a directory. Use ro run rudder instance and page.
...
++  on-init
  ^-  (quip card _this)
  =^  cards  this ::this is why you have an outgoing request for paldev when you start up. sneaky
